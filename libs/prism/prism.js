/* PrismJS 1.30.0
https://prismjs.com/download.html#themes=prism-dark&languages=markup+css+clike+javascript+basic+c+csharp+cpp+django+docker+git+go+java+javadoclike+jsdoc+json+json5+jsstacktrace+js-templates+kotlin+less+makefile+markdown+markup-templating+mongodb+n4js+nginx+objectivec+perl+php+phpdoc+python+r+typescript+typoscript+vala+vbnet+vim+visual-basic&plugins=line-highlight+line-numbers+show-invisibles+autolinker+wpd+custom-class+file-highlight+show-language+jsonp-highlight+highlight-keywords+remove-initial-line-feed+inline-color+previewers+autoloader+keep-markup+command-line+unescaped-markup+normalize-whitespace+data-uri-highlight+toolbar+copy-to-clipboard+download-button+match-braces+diff-highlight+filter-highlight-all+treeview */
